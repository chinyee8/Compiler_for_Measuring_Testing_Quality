...
public class AllPUsesCoverage {
	...
	public AllPUsesCoverage(Map<Program, MethodCall> defProgram, List<List<MyMethods>> globalReturn) {
		...
		for(Map.Entry<Program, MethodCall> prog : defProgram.entrySet()) {
			...
			for(String d: totaldef) {
				tempdiff.add("<div id=\"" + d + "pans\" hidden>" 
						+ "<div class=\""+ d +"pcolumn\"><u class=\"topic\">All-P-Uses Coverage</u><br><br>" +getResultString(globalMyMethods, p, methodcall, d) + "<br>" + "</div>"
