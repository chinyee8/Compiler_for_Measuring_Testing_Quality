...
public class exprParser extends Parser {
	...
	public static final int
		...
		RULE_void_method = 9, RULE_method_body = 10, RULE_param = 11, RULE_p_multi = 12, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"return_method", "void_method", "method_body", "param", "p_multi", "test", 
	...
	public static class MyMultiParameterContext extends ParamContext {
		public TerminalNode DATA_TYPE() { return getToken(exprParser.DATA_TYPE, 0); }
		public TerminalNode VAR_NAME() { return getToken(exprParser.VAR_NAME, 0); }
		public List<P_multiContext> p_multi() {
			return getRuleContexts(P_multiContext.class);
		}
		public P_multiContext p_multi(int i) {
			return getRuleContext(P_multiContext.class,i);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class P_multiContext extends ParserRuleContext {
		public P_multiContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_p_multi; }
	 
		public P_multiContext() { }
		public void copyFrom(P_multiContext ctx) {
			super.copyFrom(ctx);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class PMultiContext extends P_multiContext {
		public TerminalNode DATA_TYPE() { return getToken(exprParser.DATA_TYPE, 0); }
		public TerminalNode VAR_NAME() { return getToken(exprParser.VAR_NAME, 0); }
		public PMultiContext(P_multiContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof exprListener ) ((exprListener)listener).enterPMulti(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof exprListener ) ((exprListener)listener).exitPMulti(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof exprVisitor ) return ((exprVisitor<? extends T>)visitor).visitPMulti(this);
			else return visitor.visitChildren(this);
		}
	}

	public final P_multiContext p_multi() throws RecognitionException {
		P_multiContext _localctx = new P_multiContext(_ctx, getState());
		enterRule(_localctx, 24, RULE_p_multi);
		try {
			_localctx = new PMultiContext(_localctx);
			enterOuterAlt(_localctx, 1);
			{
			setState(153);
			match(DATA_TYPE);
	...
	private InputContext input(int _p) throws RecognitionException {
		...
		int _startState = 30;
		enterRecursionRule(_localctx, 30, RULE_input, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
